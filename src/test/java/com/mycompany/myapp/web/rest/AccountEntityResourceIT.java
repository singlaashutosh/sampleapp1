...
import com.mycompany.myapp.Sampleapp1App;
...
public class AccountEntityResourceIT {
    ...
    private static final String DEFAULT_ACCOUNT_ENTITY_NAME = "AAAAAAAAAA";
    private static final String UPDATED_ACCOUNT_ENTITY_NAME = "BBBBBBBBBB";
    ...
    public static AccountEntity createEntity(EntityManager em) {
        AccountEntity accountEntity = new AccountEntity()
            .code(DEFAULT_CODE)
            .accountEntityName(DEFAULT_ACCOUNT_ENTITY_NAME)
    ...
    public static AccountEntity createUpdatedEntity(EntityManager em) {
        AccountEntity accountEntity = new AccountEntity()
            .code(UPDATED_CODE)
            .accountEntityName(UPDATED_ACCOUNT_ENTITY_NAME)
    ...
    public void createAccountEntity() throws Exception {
        ...
        assertThat(testAccountEntity.getAccountEntityName()).isEqualTo(DEFAULT_ACCOUNT_ENTITY_NAME);
    ...
    @Test
    @Transactional
    public void checkAccountEntityNameIsRequired() throws Exception {
        int databaseSizeBeforeTest = accountEntityRepository.findAll().size();
        // set the field null
        accountEntity.setAccountEntityName(null);
    ...
    public void getAllAccountEntities() throws Exception {
        ...
        restAccountEntityMockMvc.perform(get("/api/account-entities?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].accountEntityName").value(hasItem(DEFAULT_ACCOUNT_ENTITY_NAME)))
    ...
    public void getAccountEntity() throws Exception {
        ...
        restAccountEntityMockMvc.perform(get("/api/account-entities/{id}", accountEntity.getId()))
            ...
            .andExpect(jsonPath("$.accountEntityName").value(DEFAULT_ACCOUNT_ENTITY_NAME))
    ...
    public void updateAccountEntity() throws Exception {
        ...
        assertThat(testAccountEntity.getAccountEntityName()).isEqualTo(UPDATED_ACCOUNT_ENTITY_NAME);
